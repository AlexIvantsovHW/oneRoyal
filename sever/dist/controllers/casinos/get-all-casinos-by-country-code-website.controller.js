...
exports.getAllCasinosByCountryCodeWebsiiteController = void 0;
const getAllCasinosByCountryCodeWebsiiteController = async (pool, req, res) => {
    ...
    console.log("---------get all casinos by country code website start request---------");
    try {
...
LIMIT $2 OFFSET $3;
      ...
      `, [
        ...
        console.log("---------get all casinos by country  website  end request---------");
...
exports.getAllCasinosByCountryCodeWebsiiteController = getAllCasinosByCountryCodeWebsiiteController;
